...
List<BookModel> dummyBooks = [
  BookModel(
    ...
    author: 'Uiara Torres',
    assetPath: 'images/book1.png',
    colorSet: BookColorSet.lightRed,
  ),
  BookModel(
    name: 'Universe of Us',
    author: 'Harley Quinn',
    assetPath: 'images/book2.png',
    colorSet: BookColorSet.lightRed,
  ),
  BookModel(
    name: 'The Poetry',
    author: 'Sylvia Plath',
    assetPath: 'images/book3.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'Wonders of Life',
    author: 'Stephen Turner',
    assetPath: 'images/book4.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'The Alchemist',
    author: 'Paulo Coelho',
    assetPath: 'images/book5.png',
    colorSet: BookColorSet.lightRed,
  ),
  BookModel(
    name: 'Turn the Page',
    author: 'Tina Turner',
    assetPath: 'images/book6.png',
    colorSet: BookColorSet.lightBlue,
  ),
  BookModel(
    name: 'Arcadia',
    author: 'Kiera Cass',
    assetPath: 'images/book7.png',
    colorSet: BookColorSet.lightPurple,
  ),
  BookModel(
    name: 'Life of wifi',
    author: 'Polina Krasnova',
    assetPath: 'images/book8.png',
    colorSet: BookColorSet.lightGreen,
  ),
  BookModel(
    name: 'The Alchemist',
    author: 'Paulo Coelho',
    assetPath: 'images/book9.png',
    colorSet: BookColorSet.lightBlue,
  ),
];
